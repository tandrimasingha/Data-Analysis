...
with open('Car_sales.csv', 'rb') as rawdata:
    result = chardet.detect(rawdata.read(100000))
result

with open('car_ad.csv', 'rb') as rawdata:
    result = chardet.detect(rawdata.read(100000))
result
...
def carprice():
        ...
        return render_template('i.html', output="{} Lakh".format(output))
